...
const ALLOW = {
  ...
  budget_rule_logs:  { read: 'executed_at,rule_id,rule_label,ad_name,adset_id,old_budget,new_budget,success', upsert: 'id' }, // 실행 로그: 자동(auto-adjust, service_role 직접) + 수동(rule_id='manual_*'). anon 읽기가 RLS에 막혀 read도 게이트웨이로
};
